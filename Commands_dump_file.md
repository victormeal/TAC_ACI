...
SWITCH# show pie interface ethernet 1/32 link-down-rca detail
```
```
LEAF# show enpoint
...
LEAF# MXS2-L103# show mcp internal info vlan 2042 << encap-vlan
```
```
...
APIC# cat /var/log/external/messages
```
### Basic Commands
```
APIC# show version
...
BLF# show bgp internal event-history logs | egrep 10.250.3.226
```
### Multicast L3
```
